...
API_ID = int(environ.get('API_ID', '23608041'))
API_HASH = environ.get('API_HASH', '43cbb86bd64ed7ca6c2f2f329a94966a')
...
# Database Channel 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003019468777').split()]
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002652025575'))

# MongoDB 
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://chitrasonmalik:piuVfhuDQ1T0bMEb@cluster0.kz6ifxp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Other Channel's
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002724342048'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0'))
request_channel = environ.get('REQUEST_CHANNEL', '') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003013190670')) 
